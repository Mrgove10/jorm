...
create table LiveAlbum (
    ...
    constraint liveAlbum_creation_ID_fk foreign key (AlbumID) references Album (ID)
...
create table BOAlbum (
    ...
    constraint boAlbum_creation_ID_fk foreign key (AlbumID) references Album (ID)
...
VALUES
  (NULL, '7', 'La promenade des égoïstes'),
